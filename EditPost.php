    ...
    <section class="container py-2 mb-4">
        <div class="row">
            ...
            <?php
               echo ErrorMessage();
               echo SuccessMessage();
               //Fetching Content to be updated
               global $ConnectingDB;
           ...
           ?>
            ...
            <form class="form-group" action="EditPost.php?id=<?php echo $SearchQueryParameter;?>" method="POST" enctype="multipart/form-data">
                <div class="card text-light px-3" style="background:#444;">
                    ...
                    <div class="card-body py-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="PostTitle" id="title" value="<?php echo $TitleToBeUpdated; ?>" placeholder="Type new category title" style="min-width:1000px">
                        </div>
                        <div class="form-group">
                            <span class="FieldInfo">Existing category: </span>
                            <?php echo $CategoryToBeUpdated ?> <BR>
                            <label for="CategoryTitle"><span class="FieldInfo">Choose Category: </span></lebel>
                            <select class="form-control" id="CategoryTitle" name="Category" value="" style="min-width:1000px">
                                <?php
                        ...
                        <img src= "uploads/<?php echo $ImageToBeUpdated?>" width="170px" height="70px"><br>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="PostDescription" value="" id="Post" cols="30" rows="10" style="min-width:1000px">
